module Piggly
  module Compiler
    module Cache
      ...
      module ClassMethods
        def cache_sources
          [compiler_path, Piggly::Parser.grammar_path, Piggly::Parser.parser_path, Piggly::Parser.nodes_path]
        end
        ...
        # returns CacheDirectory instance 
        def cache(source, args={}, &block)
          Piggly::Parser.parser # load libraries
          ...
          if stale?(source)
            begin
              ...
              CacheDirectory.lookup(cachedir, data)
            rescue Piggly::Parser::Failure
              CacheDirectory.clean(cachedir)
              raise
            end
          else
